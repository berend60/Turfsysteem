 ...
 */
public class MailJob implements org.quartz.Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        mailService.send(new String[]{"epieter.tolsma@gmail.com"}, "WATEX BEER Week " + week + " " + year, message, files);
    }

    public File generateFile(Date date) {
        try {
